...
- Project ZIP exports are generated in browser memory and contain the current board source plus JSON settings.
...
- The loader accepts direct `.kicad_pcb` files, KiCad `.zip` archives, and PCB Styler project `.zip` archives.
